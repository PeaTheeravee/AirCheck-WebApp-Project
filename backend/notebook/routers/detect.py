...
def get_quality_level(value, pollutant):
    levels = {
        'PM2.5': [
            ...
            {'range': (25.1, 35.0), 'level': 'ปานกลาง', 'fix': 'ควรสวมหน้ากาก , ควรทำความสะอาดห้อง'},
            {'range': (35.1, float('inf')), 'level': 'อันตราย', 'fix': 'ต้องสวมหน้ากาก , ใช้เครื่องฟอกอากาศ , ต้องทำความสะอาดห้องเเละทำความสะอาดแผ่นกรองแอร์'}
        ],
        'PM10': [
            {'range': (0.0, 50.0), 'level': 'ดี', 'fix': '---------'},
            {'range': (50.1, 75.0), 'level': 'ปานกลาง', 'fix': 'ควรสวมหน้ากาก , ควรทำความสะอาดห้อง'},
            {'range': (75.1, float('inf')), 'level': 'อันตราย', 'fix': 'ต้องสวมหน้ากาก , ใช้เครื่องฟอกอากาศ , ต้องทำความสะอาดห้องเเละทำความสะอาดแผ่นกรองแอร์'}
        ],
        'CO2': [
            {'range': (0.0, 1000.0), 'level': 'ดี', 'fix': '---------'},
            {'range': (1000.1, 1200.0), 'level': 'ปานกลาง', 'fix': 'เปิดหน้าต่างหรือประตูชั่วคราว , ใช้พัดลมช่วยเพิ่มการถ่ายเทอากาศ'},
            {'range': (1200.1, float('inf')), 'level': 'อันตราย', 'fix': ' เปิดหน้าต่างหรือประตูให้นานขึ้น , ใช้พัดลมช่วยเพิ่มการถ่ายเทอากาศ'}
        ],
        'TVOC': [
            {'range': (0.0, 1000.0), 'level': 'ดี', 'fix': '---------'},
            {'range': (1000.1, 1100.0), 'level': 'ปานกลาง', 'fix': 'เปิดหน้าต่างหรือประตูชั่วคราว , ใช้พัดลมช่วยเพิ่มการถ่ายเทอากาศ , ต้องค้นหาเเละกำจัดกลิ่นไม่พึงประสงค์หรือสารเคมีออกจากห้อง'},
            {'range': (1100.1, float('inf')), 'level': 'อันตราย', 'fix': 'เปิดหน้าต่างหรือประตูให้นานขึ้น , ใช้พัดลมช่วยเพิ่มการถ่ายเทอากาศ , ต้องค้นหาเเละกำจัดกลิ่นไม่พึงประสงค์หรือสารเคมีออกจากห้องทันที'}
        ],
        'Temperature': [
            {'range': (24.0, 26.0), 'level': 'ดี', 'fix': '---------'},
            {'range': (22.0, 23.99), 'level': 'ปานกลาง', 'fix': 'ปรับอุณหภูมิแอร์ให้อยู่ในช่วง 24-26°C'},
            {'range': (26.01, 28.0), 'level': 'ปานกลาง', 'fix': 'ปรับอุณหภูมิแอร์ให้อยู่ในช่วง 24-26°C'},
            ...
            {'range': (28.01, float('inf')), 'level': 'อันตราย', 'fix': 'ปรับอุณหภูมิแอร์ให้อยู่ในช่วงที่เหมาะสม , ใช้พัดลมช่วยกระจายความเย็น , ตรวจสอบการตั้งค่า ถ้าพบว่าเกิดจากการทำงานผิดปกติของเเอร์ ปิดเเอร์ เเละติดต่อช่าง'}
        ],
        'Humidity': [
            {'range': (50.0, 65.0), 'level': 'ดี', 'fix': '---------'},
            {'range': (45.0, 49.99), 'level': 'ปานกลาง', 'fix': 'เปิดใช้เครื่องพ่นไอน้ำเพื่อเพิ่มความชื้น'},
            {'range': (65.01, 70.0), 'level': 'ปานกลาง', 'fix': 'ปรับแอร์เป็น Dry Mode เพื่อลดความชื้น '},
            ...
            {'range': (70.01, float('inf')), 'level': 'อันตราย', 'fix': 'เปิดแอร์ในโหมด Dry Mode อย่างต่อเนื่อง ,  ตรวจสอบการตั้งค่า ถ้าพบว่าเกิดจากการทำงานผิดปกติของเเอร์ ปิดเเอร์ เเละติดต่อช่าง'}
        ]
    }
